...
package io.provenance.usdf.consortium.wallet.hdwallet
...
data class Bech32Data(val hrp: String, val fiveBitData: ByteArray) {
     ...
     */
    private val hexData = BaseEncoding.base16().encode(this.data)
...
class Bech32 {
    ...
    companion object {
        ...
        private const val PROVENANCE_MAINNET_PREFIX = "pb"
        ...
        private const val PROVENANCE_TESTNET_PREFIX = "tp"
        ...
        fun encode(hrp: String, fiveBitData: ByteArray): String {
            return (fiveBitData.plus(checksum(hrp, fiveBitData.toTypedArray())).map { b -> charset[b.toInt()] })
                .joinToString("", hrp + "1")
        }
